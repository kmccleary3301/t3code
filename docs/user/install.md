...
auditable install of the published `fork-v0.0.43` release, download the verification files
from that exact release, verify the installer, then run it locally:

```sh
base=https://github.com/kmccleary3301/t3code/releases/download/fork-v0.0.43
...
sh install.sh --profile pi-omp --repository kmccleary3301/t3code --version 0.0.43
```

The recorded `fork-v0.0.43` installer SHA-256 is
`ff5b3bbceacd7196b3bb06e75aa2a1afa010ce38bea88574182fc9043537ef3e`; its release-manifest
SHA-256 is `44267981e905f4dbe5b2fe35a2c50c942ff14873a1228ca17047536c2f216e7b`, and the
checksummed CLI tarball is `dff556bb845f935d2575c01e8085afd5cf86ba24e8aeed670a1e40d625f05155`.
Treat the release's `SHA256SUMS` as authoritative if this documentation and the release ever
disagree.
...
[`fork-v0.0.43`](https://github.com/kmccleary3301/t3code/releases/tag/fork-v0.0.43)
...
[macOS arm64 DMG](https://github.com/kmccleary3301/t3code/releases/download/fork-v0.0.43/T3-Code-Pi-OMP-0.0.43-arm64.dmg)
is not notarized. The fork installs side by side with upstream under a distinct bundle ID and URL
scheme. Use `fork-v0.0.43` or newer; `fork-v0.0.39` had a desktop asset-selection defect.
