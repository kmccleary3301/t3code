  ...
  return (
    <div
      ...
      className={cn(
        ...
        "[html[data-t3-appearance-active=true]_&]:[--chat-composer-glass-surface:var(--app-theme-surface-raised)] [html[data-t3-appearance-active=true]_&]:[--chat-composer-outline:var(--app-theme-toolbar-border)]",
        "dark:[html[data-t3-appearance-active=true]:not([data-theme-id=t3-chat])_&]:[--chat-composer-highlight:color-mix(in_srgb,var(--app-theme-input)_12%,transparent)] dark:[html[data-t3-appearance-active=true]:not([data-theme-id=t3-chat])_&]:[--chat-composer-outline:var(--chat-composer-outline,color-mix(in_srgb,var(--app-theme-input)_30%,var(--background)))]",
