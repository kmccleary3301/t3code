  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new KM Code prerelease is available for nightly testers."
          : "A new KM Code latest release is available.",
...
).pipe(Command.withDescription("Post a KM Code release announcement to Discord."));
